...
var getActionDescs = exports.getActionDescs = function(actionName, action, controllerName) {

	
	var baseUrl = action.baseUrl || '';
	if (baseUrl) {
		baseUrl += '/';
	}
...
var processor = exports.processor = function(app, fileName, controller) {
	...
	for(var actionName in controller) {
		...
		var actionDescs = getActionDescs(actionName, action, controllerName);
